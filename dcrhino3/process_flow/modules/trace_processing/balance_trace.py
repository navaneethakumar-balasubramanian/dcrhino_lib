...
class BalanceModule(BaseTraceModule):
    ...
    def process_component(self,component_id, component_vector, global_config):
        ...
        .. warning:: This assumes a symmetric and centered data vector obtained
            from an autocorrelation; i.e. the center value in the trace corresponds
            to lag=0 sample;

        .. warning:: number of samples in input trace is odd, and one less than some
        ...
        .. note:: 20190204: decon shift applied previously
