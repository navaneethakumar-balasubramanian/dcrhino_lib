...
datacloud_cache = os.path.join(home, '.cache/datacloud')
mont_wright_cache = os.path.join(datacloud_cache, 'mont_wright')
processed_cache = os.path.join(mont_wright_cache, 'processed')
...
#flow_path = '/home/kkappler/.cache/datacloud/line_creek/processed/793_77_23531_23531_5208_5208/v3.2.1_processing_flow'
#
#
#h5_path = os.path.join(flow_path, '4_tp_trim.h5')
#h5_path = os.path.join(flow_path, '5_tp_balance.h5')
...
#    curves_groups.append(['K0_axial_primary_max_amplitude'
    ...
    manual_picks_to_show = None
    manual_picks_to_show = {'primary':0.00018, 'multiple_1':0.0109, 'multiple_2':0.022}
    manual_window_widths_to_show = {'primary':0.001, 'multiple_1':0.001, 'multiple_2':0.001}
    picks_to_show = None
...
#    rhino_display.json_dict = rd_dict
    ...
    rhino_display.panels = [heatmap_1,]
    #pdb.set_trace()
    rhino_display.plot()
