...
def transform_configparser_to_config2(cofig_path):
    ...
    setattr(c, "bpf", bpf)
    setattr(c, "sensor_sensitiviy", sensitivities)
    output_file = cofig_path.replace(".cfg", ".json")
