...
class TraceProcessing:
    ...
    def process(self, data, data_ts, component, sensitivity, debug=False):
        ...
        # print("Inside Trace Processing",calibrated_actual_second)
        ...
        output_dict[component+'_calibrated'] = calibrated_actual_second
        if debug:
            ...
            output_dict[component+'_auto_correlated'] = correlated_trace_actual_second
