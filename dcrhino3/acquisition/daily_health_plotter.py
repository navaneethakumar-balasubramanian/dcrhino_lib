...
def main(date=None):
    ...
    try:
        ...
        ssd_plot.plot(time_axis, df.disk_usage)
        ssd_plot.set_title("Disk Usage")
        ram_plot.plot(time_axis, df.ram_usage)
        ram_plot.set_title("RAM Usage")
        tablet_battery_plot.plot(time_axis, df.tablet_battery_percentage)
        tablet_battery_plot.set_title("Tablet Battery Percentage")
        tablet_battery_status_plot.plot(time_axis, df.tablet_battery_status)
        ...
        print("Tablet diagnostics not available")
