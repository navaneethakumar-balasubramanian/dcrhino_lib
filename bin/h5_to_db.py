...
for h5_filename in h5_list:
    ...
    dbhelper.save_autocorr_traces(global_config.rig_id,global_config.sensor_serial_number,config_id,file_id,autcorrelated_dataframe['timestamp'],autcorrelated_dataframe['axial'],autcorrelated_dataframe['radial'],autcorrelated_dataframe['tangential'])
    pdb.set_trace()
