...
and plotting.  We now want these factored out.  This clas is basically a renaming
...
#/home/kkappler/software/datacloud/dcrhino_lib/dcrhino/process_pipeline/qc_log_plotter.py
