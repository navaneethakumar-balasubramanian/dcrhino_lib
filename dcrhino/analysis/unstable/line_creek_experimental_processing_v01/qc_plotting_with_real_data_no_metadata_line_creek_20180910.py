...
serial_number = 'S1008'; sampling_rate = 3200;#source='rhino';
#serial_number = '5208'; sampling_rate = 2800;#source='ssx5208';
serial_number = '5208'; sampling_rate = 3200;#source='ssx5208';
data_path = os.path.join(home, 'data/datacloud')
data_path = os.path.join(data_path,project_id,'level_1/piezo','{}'.format(serial_number), '{}hz'.format(int(sampling_rate)))
trace_array_dict = {}
for component_label in COMPONENT_LABELS:
    ...
    #pdb.set_trace()
    output_filename = '{}_{}.png'.format(project_id, serial_number)
    #pdb.set_trace()
