...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 22 10:05:41 2019
...
class QCLogPlotter_db():
    ...
    def __init__(self,axial,tangential,radial,start_ts, end_ts):
        self.axial = axial
    ...
    def qc_plot(self,qc_plot_input,
    ...
    #    Generate figure and axis objects to plot. 6 rows, not sharing X axis
        fig, ax = plt.subplots(nrows=3, sharex=False, figsize=(24,12))
...
#            trace_array_dict[component_label] = trace_array_dict[component_label][half_way-samples_back:half_way+samples_fwd,:]
            trace_array_dict[component_label] = trace_array_dict[component_label]
...
#                                                  log_depth = self.extracted_features_df['depth'],
        ...
        self.qc_plot(qc_plot_input, '', show=show,save=save)
