...
TODO: Most of these functions are slated for deprecation and are tied to either SEGY
processing or specific processing jobs from the past.  Maybe comment all functions and uncomment when needed?
