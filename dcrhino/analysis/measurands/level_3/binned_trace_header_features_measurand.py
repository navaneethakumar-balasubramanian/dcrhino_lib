...
from dcrhino.analysis.graphical.binned_qc_log_plots import BinnedQCLogPlotInput
...
#        else:
    ...
    def _make_from_parents(self, data_key, all_hole_profiles):
        """
        ...
        hole_profile_df = all_hole_profiles[all_hole_profiles['hole_id']==hole_id]
...
#            df_rhino = df_rhino[(df_rhino['peak_ampl_x'] > peak_ampl_x_lower_bound)]
    ...
    def generate_binned_qc_plot_input(self, df=None, data_key=None, observer_row=None, mount_point=None):
        """
