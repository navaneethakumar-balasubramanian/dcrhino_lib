...
from dcrhino.analysis.measurands.level_1.merged_observer_notes_measurand import MergedObserverNotes
...
def _create_merged_observer_notes_measurand():
    """
    """
    prototype_measurand = MergedObserverNotes(data_level=1,
                                           formality='development',
                                           label='merged_observer_notes',
                                           extension='csv',
                                           project_id=PROJECT_ID)
...
def _create_correlated_segy_measurands():
    """
    historical parent_measurand_strings = ['deconvolved_sgy_100ms_level1_sgy_mems',
    'deconvolved_sgy_100ms_level1_sgy_piezo']
    """
...
def register_production_measurands():
    ...
    _create_merged_observer_notes_measurand()
...
print_measurand_registry()
print_hash_dict()
OBSERVER_NOTES_DF = measurand('merged_observer_notes').load()
