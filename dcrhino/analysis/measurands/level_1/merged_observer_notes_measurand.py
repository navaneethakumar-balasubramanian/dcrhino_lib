...
class MergedObserverNotes(DerivedDataCloudMeasurand):
    """
    uses DigitzerDate DataKey
    """
    def __init__(self, **kwargs):
        super(MergedObserverNotes, self).__init__(**kwargs)
        self.extension = 'csv'
    ...
    def expected_filename(self):
        ...
        basename = '.'.join(['merged_observer_notes', self.extension])
    ...
    def load(self):
        """
        """
        df = pd.read_csv(self.expected_filename())
