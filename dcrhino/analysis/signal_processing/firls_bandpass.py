...
class FIRLSFilter(object):
    ...
    def duration_string(self):
        if self.duration is None:
            ...
            duration_string = '{}ms'.format(int(1000. * self.duration) )
        return duration_string

    @property
    def n_taps(self):
        n_taps = int(self.duration * 2. * self.nyquist)
    ...
    def id_string(self):
        """
        """
        x='{}_{}_{}'.format(self.flavor, self.corner_string, self.duration_string)
